...
const resources = {
  fr: {
    translation: {
      ...
      "ai_description": "Développement d'une solution IA pour Asterisk (VOIP) visant à automatiser la gestion des alarmes et des appels. L'objectif, en utilisant des API d'intelligence artificielle, est d'intégrer des technologies de reconnaissance vocale (ASR), de synthèse vocale (TTS), de génération de réponses via LLM, ainsi qu'un serveur d'IA capable d'analyser les situations et de prendre des décisions de manière autonome. Le but final est de réduire et filtrer jusqu'à 90 % des appels résultant d'erreurs de manipulation de la part des clients.",
        "websec_academy": "Web Security Academy - Labs",
        "websec_academy_description": "Formation en cours en hacking web sur la plateforme d'apprentissage Web Security Academy, qui propose plus de 269 laboratoires pratiques et couvre plus de 30 types de vulnérabilités. Vous trouverez ci-dessous l'ensemble de mes notes et des contenus étudiés pour tous les niveaux : Apprentice, Practitioner et Expert.",
      
      // Home2 Component
      "full_name": "Jordan Macia De Las Heras",
      "about_intro_text": "Étudiant en Mastère Expert Cybersécurité à Ynov Campus Toulouse, je suis passionné par la cybersécurité offensive et le pentesting.",
      "birth_place": "Âgé de 21 ans, je suis né en Andorre 🇦🇩, où j'ai vécu jusqu'à il y a quatre ans.",
  ...
  es: {
    translation: {
      ...
      "ai_description": "Desarrollo de una solución IA para Asterisk (VOIP) con el objetivo de automatizar la gestión de alarmas y llamadas. La idea es integrar reconocimiento de voz (ASR), síntesis de voz (TTS) y generación de respuestas con modelos LLM en un servidor Asterisk para que la IA analice situaciones y actúe de forma autónoma, con la intención de reducir y filtrar hasta el 90% de las llamadas causadas por errores de manejo por parte de los clientes.",
      ...
      "websec_academy": "Web Security Academy - Labs",
      "websec_academy_description": "Actualmente realizando formación en hacking web en la plataforma de aprendizaje Web Security Academy, que ofrece más de 269 laboratorios prácticos y cubre más de 30 tipos de vulnerabilidades. A continuación encontrarás todas mis notas y contenidos estudiados para todos los niveles: Apprentice, Practitioner y Expert.",
      
      // Home2 Component
      "full_name": "Jordan Macia De Las Heras",
      "about_intro_text": "Estudiante de Mastère Experto en Ciberseguridad en Ynov Campus Toulouse, apasionado por la ciberseguridad ofensiva y el pentesting.",
      "birth_place": "Con 21 años, nací en Andorra 🇦🇩, donde viví hasta hace cuatro años.",
  ...
  ad: {
    translation: {
      ...
      "ai_description": "Desenvolupament d'una solució IA per Asterisk (VOIP) amb l'objectiu d'automatitzar la gestió d'alarmes i trucades. La idea és integrar reconeixement de veu (ASR), síntesi de veu (TTS) i generació de respostes amb models LLM en un servidor Asterisk perquè la IA analitzi situacions i actuï de forma autònoma, amb la intenció de reduir i filtrar fins al 90% de les trucades causades per errors de manipulació dels clients.",
      ...
      "websec_academy": "Web Security Academy - Labs",
      "websec_academy_description": "Actualment cursant formació en hacking web a la plataforma d'aprenentatge Web Security Academy, que ofereix més de 269 laboratoris pràctics i cobreix més de 30 tipus de vulnerabilitats. A continuació trobaràs totes les meves notes i continguts estudiats per a tots els nivells: Apprentice, Practitioner i Expert.",
      
      // Home2 Component
      "full_name": "Jordan Macia De Las Heras",
      "about_intro_text": "Estudiant del Mastère Expert en Ciberseguretat a Ynov Campus Toulouse, apassionat per la ciberseguretat ofensiva i el pentesting.",
      "birth_place": "Amb 21 anys, vaig néixer a Andorra 🇦🇩, on vaig viure fins fa quatre anys.",
      "languages": "Idiomes: Espanyol, Català, Francès, Anglès",
      
      // Education
      "education": "Estudis",
      "master_title": "Mastère Expert en Ciberseguretat (Alternança)",
      "master_school": "Ynov Campus (2025-2027)",
      "master_coming_soon": "...",
  ...
  en: {
    translation: {
      ...
      "ai_description": "Development of an AI solution for Asterisk (VOIP) aiming to automate alarm and call management. The objective is to integrate voice recognition (ASR), text-to-speech (TTS) and LLM-based response generation into an Asterisk server so the AI can analyze situations and act autonomously, aiming to reduce and filter up to 90% of calls caused by customer handling errors.",
      ...
      "websec_academy": "Web Security Academy - Labs",
      "websec_academy_description": "Currently undergoing web hacking training on the Web Security Academy learning platform, which offers over 269 hands-on labs and covers more than 30 vulnerability types. Below you will find all my notes and studied materials for all levels: Apprentice, Practitioner, and Expert.",
      
      // Home2 Component
      "full_name": "Jordan Macia De Las Heras",
      "about_intro_text": "Mastère Expert Cybersecurity student at Ynov Campus Toulouse, passionate about offensive cybersecurity and pentesting.",
      "birth_place": "At 21 years old, I was born in Andorra 🇦🇩, where I lived until four years ago.",
